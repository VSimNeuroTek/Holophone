...
set "BACKUP=%TARGET%\_backup_patch_3.1.1"

echo ============================================================
echo  HOLOPHONE - PATCH 3.1.1 - VSNT / BOOT SPLASH
echo ============================================================
echo.
echo Cible : %TARGET%
echo.
...
if not exist "%TARGET%\www\index.html" (
  ...
  echo   APPLIQUER_PATCH_3.1.1.cmd "C:\chemin\vers\Holophone"
  pause
  exit /b 1
)

if not exist "%BACKUP%\www\js" mkdir "%BACKUP%\www\js" >nul 2>&1
if not exist "%BACKUP%\scripts" mkdir "%BACKUP%\scripts" >nul 2>&1
...
echo [2/3] Installation des fichiers 3.1.1...
...
if errorlevel 1 goto :copy_error
call :install "RELEASE_3.1.1.cmd"
if errorlevel 1 goto :copy_error
call :install "TESTER_STABLE_3.1.1.cmd"
if errorlevel 1 goto :copy_error
call :install "scripts\release-safe.ps1"
if errorlevel 1 goto :copy_error
call :install "scripts\test-stable-v311.js"
if errorlevel 1 goto :copy_error
call :install "scripts\patches\local-notifications\SoundResolver.kt"
if errorlevel 1 goto :copy_error
call :install "CHANGEMENTS_3.1.1.md"
if errorlevel 1 goto :copy_error
call :install "RELEASE_3.1.1.md"
if errorlevel 1 goto :copy_error
call :install "VALIDATION_3.1.1.md"
if errorlevel 1 goto :copy_error
call :install "ARCHITECTURE_BOOT_3.1.1.md"
if errorlevel 1 goto :copy_error
call :install "HOLOPHONE_MASTER_HANDOFF_3.1.1.md"
if errorlevel 1 goto :copy_error
...
echo   %TARGET%\RELEASE_3.1.1.cmd
echo.
echo Version attendue : 3.1.1 / versionCode 43
pause
exit /b 0
