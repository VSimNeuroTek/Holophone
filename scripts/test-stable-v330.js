...
test('Version web 3.3.0',()=>{contains(html,"const APPV='3.3.0'");contains(v2,"version: '3.3.0'");contains(stable,"const STABLE_VERSION = '3.3.0'");return'APPV, V2, stabilité'});
...
test('Release 3.3.0 / code 51',()=>{contains(read('RELEASE.cmd'),'VERSION_NAME=3.3.0');contains(read('RELEASE.cmd'),'VERSION_CODE=51');contains(read('RELEASE_3.3.0.cmd'),'3.3.0 51');return'version Android'});
test('Outillage 3.3.0 présent',()=>{['TESTER_STABLE_3.3.0.cmd','RELEASE_3.3.0.cmd','scripts/test-stable-v330.js'].forEach(p=>assert(exists(p),'absent: '+p));return'OK'});
...
console.log('\nHOLOPHONE 3.3.0 — RECETTE STATIQUE\n===================================');
