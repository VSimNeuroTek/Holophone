...
test('Version web 3.0.0',()=>{contains(html,"const APPV='3.0.0'");contains(v2,"version: '3.0.0'");return'APPV et V2'});
...
test('Schéma 3000 et migrations',()=>{contains(stable,'const SCHEMA_VERSION = 3000');contains(stable,'MIGRATIONS');contains(stable,'baseline-stable-3.0.0');return'schéma 3000'});
...
test('Fichiers stabilité présents',()=>{['www/js/holophone-stability.js','TESTER_STABLE_3.0.0.cmd','RELEASE.cmd'].forEach(p=>assert(exists(p),'absent: '+p));return'outillage présent'});
...
console.log('');
console.log('HOLOPHONE 3.0.0 — RECETTE STATIQUE');
console.log('===================================');
