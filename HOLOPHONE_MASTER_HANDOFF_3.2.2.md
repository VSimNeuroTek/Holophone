# HOLOPHONE — DOCUMENT MAÎTRE DE PASSATION 3.2.2

**Référence actuelle : Holophone 3.2.2 — Continuité vivante + VSNT System Profile bilingue**  
**Android : `versionName "3.2.2"` / `versionCode 49`**  
...
> **Priorité documentaire :** le **Delta courant 3.2.2** ci-dessous prime sur toute règle contradictoire des sections historiques. Les sections 3.1.x et antérieures sont conservées pour comprendre les choix et les compatibilités, mais ne doivent pas être prises comme l'état courant lorsqu'elles divergent.
