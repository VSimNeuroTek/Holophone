...
test('Version web 3.1.2',()=>{contains(html,"const APPV='3.1.2'");contains(v2,"version: '3.1.2'");return'APPV et V2'});
...
test('Fichiers stabilité présents',()=>{['www/js/holophone-stability.js','TESTER_STABLE_3.1.2.cmd','RELEASE.cmd'].forEach(p=>assert(exists(p),'absent: '+p));return'outillage présent'});
...
console.log('');
console.log('HOLOPHONE 3.1.2 — RECETTE STATIQUE');
console.log('===================================');
