...
test('Version web 3.1.1',()=>{contains(html,"const APPV='3.1.1'");contains(v2,"version: '3.1.1'");return'APPV et V2'});
...
test('Identité VSim NeuroTek',()=>{contains(html,'Holophone™');contains(html,'VSim NeuroTek');contains(html,'VSNT');contains(html,'Connecting Mind &amp; Bytes.');return'branding splash + à propos'});
...
test('Fichiers stabilité présents',()=>{['www/js/holophone-stability.js','TESTER_STABLE_3.1.1.cmd','RELEASE.cmd'].forEach(p=>assert(exists(p),'absent: '+p));return'outillage présent'});
...
console.log('');
console.log('HOLOPHONE 3.1.1 — RECETTE STATIQUE');
console.log('===================================');
