# HOLOPHONE — DOCUMENT MAÎTRE DE PASSATION 3.1.4

**Référence actuelle : Holophone 3.1.4 — Persona neutre & Android full immersive**  
**Android : `versionName "3.1.4"` / `versionCode 46`**  
...
> **Priorité documentaire :** le **Delta courant 3.1.4** ci-dessous prime sur toute règle contradictoire des sections historiques.

---

# 0. Delta courant 3.1.4 — à lire en premier
