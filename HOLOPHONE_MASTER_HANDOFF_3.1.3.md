# HOLOPHONE — DOCUMENT MAÎTRE DE PASSATION 3.1.3

**Référence actuelle : Holophone 3.1.3 — Lot 2 / correctif persistance média**  
**Android : `versionName "3.1.3"` / `versionCode 45`**  
...
> **Priorité documentaire :** le **Delta courant 3.1.3** ci-dessous prime sur toute règle contradictoire des sections historiques.
